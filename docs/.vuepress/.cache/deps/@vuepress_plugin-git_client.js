import {
  isLinkHttp,
  useLocale
} from "./chunk-CVYXTQQJ.js";
import {
  useToggle
} from "./chunk-KC2WC2ZC.js";
import {
  computed,
  defineComponent,
  h,
...
var useLastUpdated = (enabled = true) => {
  ...
  return computed(() => {
    ...
    if (!toValue(enabled))
      return null;
    const timeStamp = ((_a = page.value.git) == null ? void 0 : _a.updatedTime) ?? ((_c = (_b = page.value.git) == null ? void 0 : _b.changelog) == null ? void 0 : _c[0].time);
    if (!timeStamp)
      return null;
...
import "C:/Users/29657/vuepress-starter/node_modules/@vuepress/plugin-git/lib/client/styles/contributors.css";
...
import "C:/Users/29657/vuepress-starter/node_modules/@vuepress/plugin-git/lib/client/styles/vars.css";
import "C:/Users/29657/vuepress-starter/node_modules/@vuepress/plugin-git/lib/client/styles/changelog.css";
