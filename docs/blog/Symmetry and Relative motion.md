...
从醉鬼$A$的视角来看，$B$每一次行动可以分为：距离$A$不动，距离$A$往左走2步，或者距离$A$往右走2步。 两人最终相遇，相当于往左走的总部数$N_l$等于往右走的总步数$N_r$.故$$P=\sum_{a=0}^{\big [\cfrac N 2\big ]}\cfrac {A_N^N}{(A_a^a)^2}(\cfrac {1}{4})^a(\cfrac {1}{4})^a(\cfrac {1}{2})^{N-2a}
