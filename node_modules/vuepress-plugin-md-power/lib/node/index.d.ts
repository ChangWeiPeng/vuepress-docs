...
//#endregion
//#region src/shared/obsidian.d.ts
 ...
 */
declare function getImageOriginalSize(image: string | null | undefined, includeRemote?: boolean): Promise<ImgSize | null>;
/**
 ...
 */
declare function resolveImagePath(app: App, src?: string | null, currentPath?: string | null): string;
//#endregion
...
//#endregion
export { AcFunTokenMeta, ArtPlayerTokenMeta, BilibiliTokenMeta, CanIUseMode, CanIUseOptions, CanIUseTokenMeta, CodeSandboxTokenMeta, CodeTabsOptions, CodepenTokenMeta, CommonLocaleData, DemoContainerRender, DemoFile, DemoMeta, FileTreeIconMode, FileTreeOptions, FontAwesomeAssetBuiltIn, FontAwesomePrefix, FontAwesomeProvider, IconAssetLink, IconFontProvider, IconOptions, IconProviderBase, IconifyPrefix, IconifyProvider, JSFiddleTokenMeta, LiteralUnion, MDPowerLocaleData, MarkdownDemoEnv, MarkdownEnvPreset, MarkdownPowerPluginOptions, NpmToOptions, NpmToPackageManager, PDFEmbedType, PDFOptions, PDFTokenMeta, PlotOptions, QRCodeMeta, QRCodeProps, ReplEditorData, ReplOptions, ReplitTokenMeta, SizeOptions, ThemeOptions, VideoOptions, YoutubeTokenMeta, createCodeTabIconGetter, getImageOriginalSize, markdownPowerPlugin, resolveImagePath };